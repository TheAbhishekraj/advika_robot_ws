...
> See [docs/PREREQUISITES_CHECK.md](docs/PREREQUISITES_CHECK.md) for full manual verification criteria.
...
|------|--------|--------------------------|--------------|
| **Week 1** | Basic Bringup & Teleop | `ros2 launch advika_sim sim_bringup.launch.py` | [SIMULATION_MASTER_GUIDE.md](docs/SIMULATION_MASTER_GUIDE.md) |
| **Week 2** | URDF & Sensor Inspection | Inspect `/advika/scan`, `/advika/odom`, `/advika/imu/data` | [docs/PREREQUISITES_CHECK.md](docs/PREREQUISITES_CHECK.md) |
| **Week 3** | 3BHK World Navigation & SLAM | `ros2 launch advika_sim sim_bringup.launch.py world_file:=3bhk_house.world use_nav2:=true` | [3BHK_SIMULATION.md](docs/3BHK_SIMULATION.md) |
| **Week 4** | HITL Web Dashboard | `ros2 launch advika_sim sim_bringup.launch.py use_hitl:=true` → Visit `http://localhost:8080` | [COMMANDS_REFERENCE.md](docs/COMMANDS_REFERENCE.md) |
...
1. Complete Bill of Materials check in [docs/BOM.md](docs/BOM.md).
...
|----------|----------|---------|
| 🔴 **High** | [SETUP.md](SETUP.md) | **This Document** — Complete step-by-step setup & execution path |
| 🔴 **High** | [PREREQUISITES_CHECK.md](docs/PREREQUISITES_CHECK.md) | Detailed prerequisite check sheet with expected values |
| 🟡 **Medium** | [SIMULATION_MASTER_GUIDE.md](docs/SIMULATION_MASTER_GUIDE.md) | 9-week simulation learning curriculum & sensor tuning |
| 🟡 **Medium** | [COMMANDS_REFERENCE.md](docs/COMMANDS_REFERENCE.md) | Complete searchable command reference for all terminal tasks |
| 🟡 **Medium** | [SIMULATION_FIRST_CHECKLIST.md](docs/SIMULATION_FIRST_CHECKLIST.md) | Milestone verification checklist for each phase |
